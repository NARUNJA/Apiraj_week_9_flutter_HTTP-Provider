...
class _FlutterLayoutArticleState extends State<FlutterLayoutArticle> {
  ...
  int count; // เลขตัวอย่าง
  Widget example; // โครงสร้างตัวอย่าง
  String tite;
  String explanation; // ข้อความคำอธิบาย
                      ...
                      Container(
                        ...
                        child: Container(
                          decoration: const BoxDecoration(
                            gradient: LinearGradient(
                              colors: [
                                Color.fromRGBO(190, 150, 30, 0),
                                Color.fromRGBO(100, 220, 30, 1),
                              ],
                              begin: FractionalOffset.bottomCenter,
                              end: FractionalOffset.topCenter,
                            ),
                        ...
                        height: 275, //พื้นที่แสดง ข้อความ
...
class Button extends StatelessWidget {
  ...
  const Button({
    Key key, // เป็นค่า parameter ที่เราจำเป็นต้องกำหนดค่าสำหรับใช้งานในฟังก์ชั่น
    this.isSelected,
    this.exampleNumber,
    this.tite,
    this.onPressed,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Image.network(
          'https://scontent.fcnx2-1.fna.fbcdn.net/v/t1.6435-9/54728931_2282431472079893_5926909453772259328_n.jpg?_nc_cat=109&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=rbG8JpEGiAsAX-c53QU&_nc_ht=scontent.fcnx2-1.fna&oh=00_AT-5AtGN7nHoaM5IJzHDn5Jq8cE2p8XxiiXl2wv0cvbP9Q&oe=621C2F31',
          height: 240,
          width: 240,
          fit: BoxFit.cover,
        ),
